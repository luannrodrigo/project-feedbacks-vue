<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div
        v-else
        class="flex items-center justify-between w-full py-3 pl-5 mt-2 rounded bg-brand-gray lg:w-1/2"
      >
      ...
      <div
        v-else
        class="w-full py-3 pl-5 pr-20 mt-2 overflow-x-scroll rounded bg-brand-gray lg:w-2/3"
      >
